<template>
  <div :class="['bg-white shadow-sm rounded-xl border border-gray-200 overflow-hidden hover:border-indigo-300 transition-colors', compact ? 'p-4' : 'p-6']">
    <div>
      ...
      <div :class="[compact ? 'mt-3 pt-3' : 'mt-4 pt-4']">
        <div class="collapse collapse-arrow border border-gray-100 rounded-lg">
          <input type="checkbox" v-model="reviewOpen" />
          <div class="collapse-title text-md font-semibold text-neutral">Review</div>
          <div class="collapse-content space-y-4">
            <div class="flex flex-wrap gap-4">
              <div class="w-40 text-sm font-semibold ">Current status</div>
              <div class="flex-1">
            ...
            <div class="flex flex-wrap gap-4">
              <div class="w-40 text-sm font-semibold text-gray-600">Category</div>
    ...
    <div class="flex flex-wrap gap-4">
      <div class="w-40 text-sm font-semibold text-gray-600">Review flags</div>
...
<div class="flex flex-wrap gap-4">
  <div class="w-40 text-sm font-semibold text-gray-600">Reclassify</div>
  <div class="flex-1 flex flex-wrap items-center gap-2">
...
<script setup>
  ...
  watch(
  () => displayCategoryId.value,
  (value) => {
    const isOther = value === "other" || value === "uncategorized";
    reviewOpen.value = isOther;
  },
  { immediate: true }
  );
